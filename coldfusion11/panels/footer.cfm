<!---
  Created by swhee_000 on 9/27/2014.
--->
<footer>
    <div class="footer-content width">
        <ul>
            ...
            <li><a href="helloWorldForm.cfm">Hello World!</a></li>
            <li><a href="userList.cfm">Basic CRUD Example</a></li>
        </ul>
    ...
    <div class="footer-bottom">
        <p>&copy; ShawnSoft 2014 - <a href="http://zypopwebtemplates.com/" target="_blank">Free CSS Website Templates</a> by ZyPOP</p>
    </div>
</footer>
